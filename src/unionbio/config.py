...
main_img_fqn = "docker.io/unionbio/main:TTVOcBbtyM8CWIdmXIIY7A"
folding_img_fqn = "docker.io/unionbio/folding:HcErvfGfggQr6702XsYGmw"
parabricks_img_fqn = "docker.io/unionbio/parabricks:FJVYrzI_kbqgzRgaWdp9VA"
